...
export default function Assignments() {
  ...
  // filter only the assignments for that course
  ...
  return (
    <div className="p-3">
      ...
      <ListGroup className="rounded-0">
       ...
       <BsGripVertical className="me-2" />
       <FaRegFileAlt className="me-2 text-success" />           {/* ← green file icon */}
       <Link
       ...
       >
         <strong style={{ fontSize: "1.1rem" }}>{a.title}</strong>
              ...
              <div className="text-secondary mb-1" style={{ fontSize: "0.9rem" }}>
                {/* you can extend assignments.json with due/available fields later */}
